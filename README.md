...
This is a simple base with cmake already setup that you can use to create a exefs hakkun base for your selected game.

# Setup

All you need to do is add a submodule for your libraries, change the title id in main.json and configure config.cmake accordingly

# Original Hakkun README
